...
public class Main2 {
    ...
    public static void main(String[] args) throws NoSuchMethodException, NoSuchFieldException {
        ...
        /* Now, using ContainerWrapper2
        *  After, this we find that the reflection APIs do have all the information that
        *  they required in order to correctly infer the type parameters. This is true for
        *  parameterized return type, the parameterized input parameters, and even for the
        *  parameterized field. */
        ContainerWrapper2 containerWrapper = new ContainerWrapper2(container);
